<?php
echo "Ответ честно взяла у Алексея, спасибо ему за это: https://stackoverflow.com/questions/8456538/origin-null-is-not-allowed-by-access-control-allow-origin 
